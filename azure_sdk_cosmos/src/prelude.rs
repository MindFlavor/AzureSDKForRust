...
pub use crate::{
    ...
    AttachmentTrait, AuthorizationToken, CollectionClient, CollectionClientRequired,
    ...
    ContinuationOption, ContinuationSupport, CosmosClient, CosmosClientRequired, CosmosTrait,
    DatabaseClient, DatabaseClientRequired, DatabaseNameRequired, DatabaseNameSupport,
    DatabaseTrait, DocumentClient, DocumentIdRequired, DocumentIdSupport, DocumentRequired,
    DocumentSupport, DocumentTrait, ExpirySecondsOption, ExpirySecondsSupport, IndexingDirective,
