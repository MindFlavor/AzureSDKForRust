...
pub use crate::{
    ...
    ContinuationSupport, CosmosClient, CosmosClientRequired, CosmosTrait, DatabaseClient,
    DatabaseClientRequired, DatabaseNameRequired, DatabaseNameSupport, DatabaseTrait,
    DocumentIdRequired, DocumentIdSupport, DocumentRequired, DocumentSupport, DocumentTrait,
    ExpirySecondsOption, ExpirySecondsSupport, IndexingDirective, IndexingDirectiveOption,
    IndexingDirectiveSupport, IndexingPolicyRequired, IndexingPolicySupport, IntoDatabaseClient,
